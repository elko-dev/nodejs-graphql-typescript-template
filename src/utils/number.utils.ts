...
export const generateRandomNumber = (min: number, max: number): number => randomNumber(min, max);
export const randomNumberRange = (min: number, max: number): number => randomNumber(min, max);
